import {
  ...
  Collapse_default,
  createPopper
} from "./chunk-SHVSP4OY.js";
import "./chunk-NOUZEL6E.js";
import {
  useThemeProps
} from "./chunk-P3VFSJDZ.js";
import "./chunk-TJ4WWSAQ.js";
import "./chunk-SHVDP5GF.js";
import "./chunk-5VBY2I4W.js";
import "./chunk-CLX7OFGT.js";
import {
  require_react_dom
...
import {
  alpha,
  useRtl
} from "./chunk-VL44N2UG.js";
import {
  combineHooksSlotProps,
  useButton
} from "./chunk-6MUKDN55.js";
import "./chunk-LEC2UYGH.js";
import {
  init_utils
} from "./chunk-5CKBIOCO.js";
import {
  createSvgIcon
} from "./chunk-ZVJ5SLAB.js";
import "./chunk-HJVNVRNA.js";
import "./chunk-KRIT63CB.js";
import "./chunk-V2H5T6RJ.js";
import "./chunk-K3E22RSN.js";
import {
  require_createStyled,
  styled_default
} from "./chunk-MMALQZUK.js";
import "./chunk-HBLUZIRP.js";
import {
  ListActionTypes,
  ListContext,
  handleItemSelection,
...
var buildSiblingIndexes = (siblings) => {
  ...
  siblings.forEach((childId, index2) => {
    siblingsIndexLookup[childId] = index2;
  });
...
var useTreeViewExpansion = ({
  ...
  const isItemExpandable3 = React9.useCallback((itemId) => {
    var _a;
...
var TreeViewChildrenItemContext = React15.createContext(null);
if (true) {
...
function TreeViewChildrenItemProvider(props) {
  ...
  const childrenIdAttrToIdRef = React15.useRef(/* @__PURE__ */ new Map());
  React15.useEffect(() => {
    if (!rootRef.current) {
      return;
    }
    ...
    const hasChanged = childrenIds.length !== previousChildrenIds.length || childrenIds.some((childId, index2) => childId !== previousChildrenIds[index2]);
    if (hasChanged) {
...
var useTreeViewJSXItemsItemPlugin = ({
  ...
  const parentContext = React16.useContext(TreeViewChildrenItemContext);
  ...
  const pluginContentRef = React16.useRef(null);
...
useTreeViewJSXItems.wrapItem = ({
  ...
  const depthContext = React16.useContext(TreeViewItemDepthContext);
...
var SimpleTreeView = React17.forwardRef(function SimpleTreeView2(inProps, ref) {
...
var TreeView = React18.forwardRef(function TreeView2(inProps, ref) {
  if (true) {
    warn();
  }
...
function ClickAwayListener(props) {
  ...
  return (0, import_jsx_runtime10.jsx)(React21.Fragment, {
...
var _excluded26 = ["classes", "className", "displayIcon", "expansionIcon", "icon", "label", "itemId", "onClick", "onMouseDown"];
var TreeItemContent = React71.forwardRef(function TreeItemContent2(props, ref) {
  const {
    classes,
    className,
    displayIcon,
  ...
  const checkboxRef = React71.useRef(null);
  ...
  return (
    ...
    (0, import_jsx_runtime48.jsxs)("div", _extends({}, other, {
      ...
      children: [(0, import_jsx_runtime48.jsx)("div", {
        ...
        children: icon
      }), checkboxSelection && (0, import_jsx_runtime48.jsx)(Checkbox_default, {
...
true ? TreeItemContent.propTypes = {
   ...
   * The id of the item.
   */
  itemId: import_prop_types30.default.string.isRequired,
  /**
   * The tree item label.
   */
...
var TreeViewExpandIcon = createSvgIcon((0, import_jsx_runtime49.jsx)("path", {
  d: "M10 6 8.59 7.41 13.17 12l-4.58 4.59L10 18l6-6z"
}), "TreeViewExpandIcon");
var TreeViewCollapseIcon = createSvgIcon((0, import_jsx_runtime49.jsx)("path", {
...
TreeItem2Provider.propTypes = {
  ...
  itemId: import_prop_types31.default.string.isRequired
};

// node_modules/@mui/x-tree-view/TreeItem/TreeItem.js
var import_jsx_runtime50 = __toESM(require_jsx_runtime());
var _excluded27 = ["children", "className", "slots", "slotProps", "ContentComponent", "ContentProps", "itemId", "id", "label", "onClick", "onMouseDown", "onFocus", "onBlur", "onKeyDown"];
...
var TreeItem = React73.forwardRef(function TreeItem2(inProps, inRef) {
  const {
    icons: contextIcons,
    runItemPlugins,
    selection: {
  ...
  const depthContext = React73.useContext(TreeViewItemDepthContext);
  ...
  }), expansionIconProps = _objectWithoutPropertiesLoose(_useSlotProps, _excluded28);
  const expansionIcon = expandable && !!ExpansionIcon ? (0, import_jsx_runtime50.jsx)(ExpansionIcon, _extends({}, expansionIconProps)) : null;
  ...
  const displayIcon = DisplayIcon ? (0, import_jsx_runtime50.jsx)(DisplayIcon, _extends({}, displayIconProps)) : null;
  ...
  const icon = Icon ? (0, import_jsx_runtime50.jsx)(Icon, _extends({}, iconProps)) : null;
  let ariaSelected;
  if (multiSelect) {
  ...
  return (0, import_jsx_runtime50.jsx)(TreeItem2Provider, {
    itemId,
    children: (0, import_jsx_runtime50.jsxs)(TreeItemRoot, _extends({
...
true ? TreeItem.propTypes = {
   ...
   * The id of the item.
   */
  itemId: import_prop_types32.default.string.isRequired,
  /**
   * The tree item label.
   */
...
function WrappedTreeItem({
  ...
  return (0, import_jsx_runtime51.jsx)(Item, _extends({}, itemProps, {
    children
  }));
}
...
var RichTreeView = React74.forwardRef(function RichTreeView2(inProps, ref) {
  ...
  const renderItem = ({
    ...
    return (0, import_jsx_runtime51.jsx)(WrappedTreeItem, {
      slots,
      slotProps,
      label,
      id,
  ...
  return (0, import_jsx_runtime51.jsx)(TreeViewProvider, {
    value: contextValue,
...
true ? RichTreeView.propTypes = {
  ...
  apiRef: import_prop_types33.default.shape({
    current: import_prop_types33.default.shape({
      focusItem: import_prop_types33.default.func.isRequired,
      getItem: import_prop_types33.default.func.isRequired,
      getItemDOMElement: import_prop_types33.default.func.isRequired,
      getItemOrderedChildrenIds: import_prop_types33.default.func.isRequired,
      getItemTree: import_prop_types33.default.func.isRequired,
      selectItem: import_prop_types33.default.func.isRequired,
      setItemExpansion: import_prop_types33.default.func.isRequired
    })
  }),
  /**
   * If `true`, the tree view renders a checkbox at the left of its label that allows selecting it.
   * @default false
   */
  checkboxSelection: import_prop_types33.default.bool,
  /**
   * Override or extend the styles applied to the component.
   */
   ...
   * @default []
   */
  defaultExpandedItems: import_prop_types33.default.arrayOf(import_prop_types33.default.string),
  /**
   * Selected item ids. (Uncontrolled)
   * When `multiSelect` is true this takes an array of strings; when false (default) a string.
   * @default []
   */
  defaultSelectedItems: import_prop_types33.default.any,
  /**
   * If `true`, will allow focus on disabled items.
   * @default false
   */
   ...
   * @default false
   */
  disableSelection: import_prop_types33.default.bool,
  /**
   * Expanded item ids.
   * Used when the item's expansion is controlled.
   */
  expandedItems: import_prop_types33.default.arrayOf(import_prop_types33.default.string),
  /**
   * The slot that triggers the item's expansion when clicked.
   * @default 'content'
   */
  expansionTrigger: import_prop_types33.default.oneOf(["content", "iconContainer"]),
  /**
   * Unstable features, breaking changes might be introduced.
   * For each feature, if the flag is not explicitly set to `true`,
   * the feature will be fully disabled and any property / method call will not have any effect.
  ...
  experimentalFeatures: import_prop_types33.default.shape({
    indentationAtItemLevel: import_prop_types33.default.bool
  }),
  /**
   ...
   */
  getItemId: import_prop_types33.default.func,
  /**
   ...
   */
  getItemLabel: import_prop_types33.default.func,
  /**
   * This prop is used to help implement the accessibility logic.
   * If you don't provide this prop. It falls back to a randomly generated id.
   */
   ...
   */
  isItemDisabled: import_prop_types33.default.func,
  /**
   * Horizontal indentation between an item and its children.
   * Examples: 24, "24px", "2rem", "2em".
   * @default 12px
   */
  itemChildrenIndentation: import_prop_types33.default.oneOfType([import_prop_types33.default.number, import_prop_types33.default.string]),
  items: import_prop_types33.default.array.isRequired,
  /**
   * If `true`, `ctrl` and `shift` will trigger multiselect.
   * @default false
   */
  multiSelect: import_prop_types33.default.bool,
  /**
   * Callback fired when tree items are expanded/collapsed.
   * @param {React.SyntheticEvent} event The DOM event that triggered the change.
   * @param {array} itemIds The ids of the expanded items.
   */
  onExpandedItemsChange: import_prop_types33.default.func,
  /**
   * Callback fired when a tree item is expanded or collapsed.
   * @param {React.SyntheticEvent} event The DOM event that triggered the change.
   * @param {array} itemId The itemId of the modified item.
   * @param {array} isExpanded `true` if the item has just been expanded, `false` if it has just been collapsed.
   */
  onItemExpansionToggle: import_prop_types33.default.func,
  /**
   * Callback fired when tree items are focused.
   * @param {React.SyntheticEvent} event The DOM event that triggered the change. **Warning**: This is a generic event not a focus event.
   * @param {string} itemId The id of the focused item.
   * @param {string} value of the focused item.
   */
  onItemFocus: import_prop_types33.default.func,
  /**
   * Callback fired when a tree item is selected or deselected.
   * @param {React.SyntheticEvent} event The DOM event that triggered the change.
   * @param {array} itemId The itemId of the modified item.
   * @param {array} isSelected `true` if the item has just been selected, `false` if it has just been deselected.
   */
  onItemSelectionToggle: import_prop_types33.default.func,
  /**
   * Callback fired when tree items are selected/deselected.
   * @param {React.SyntheticEvent} event The DOM event that triggered the change.
   * @param {string[] | string} itemIds The ids of the selected items.
   * When `multiSelect` is `true`, this is an array of strings; when false (default) a string.
   */
  onSelectedItemsChange: import_prop_types33.default.func,
  /**
   * Selected item ids. (Controlled)
   * When `multiSelect` is true this takes an array of strings; when false (default) a string.
   */
  selectedItems: import_prop_types33.default.any,
  /**
   * The props used for each component slot.
   * @default {}
   */
...
var useTreeItem2 = (parameters) => {
  ...
  const depthContext = React75.useContext(TreeViewItemDepthContext);
  const {
    id,
    itemId,
    label,
  ...
  const checkboxRef = React75.useRef(null);
  const createRootHandleFocus = (otherHandlers) => (event) => {
    var _a;
    (_a = otherHandlers.onFocus) == null ? void 0 : _a.call(otherHandlers, event);
    if (event.defaultMuiPrevented) {
...
function TreeItem2Icon(props) {
  ...
  return (0, import_jsx_runtime52.jsx)(Icon, _extends({}, iconProps));
}
true ? TreeItem2Icon.propTypes = {
  ...
  status: import_prop_types34.default.shape({
    disabled: import_prop_types34.default.bool.isRequired,
    expandable: import_prop_types34.default.bool.isRequired,
    expanded: import_prop_types34.default.bool.isRequired,
    focused: import_prop_types34.default.bool.isRequired,
    selected: import_prop_types34.default.bool.isRequired
  }).isRequired
} : void 0;

// node_modules/@mui/x-tree-view/TreeItem2/TreeItem2.js
var import_jsx_runtime53 = __toESM(require_jsx_runtime());
var _excluded29 = ["visible"];
var _excluded210 = ["id", "itemId", "label", "disabled", "children", "slots", "slotProps"];
...
var TreeItem2Content = styled_default("div", {
  ...
  shouldForwardProp: (prop) => (0, import_createStyled2.shouldForwardProp)(prop) && prop !== "status" && prop !== "indentationAtItemLevel"
})(({
  theme
}) => ({
  padding: theme.spacing(0.5, 1),
...
var TreeItem2GroupTransition = styled_default(Collapse_default, {
  ...
  slot: "GroupTransition",
  overridesResolver: (props, styles2) => styles2.groupTransition,
  shouldForwardProp: (prop) => (0, import_createStyled2.shouldForwardProp)(prop) && prop !== "indentationAtItemLevel"
})({
  margin: 0,
  padding: 0,
  paddingLeft: "var(--TreeView-itemChildrenIndentation)",
...
var TreeItem2Checkbox = styled_default(React77.forwardRef((props, ref) => {
  const {
    visible
  ...
  return (0, import_jsx_runtime53.jsx)(Checkbox_default, _extends({}, other, {
    ref
  }));
}), {
  name: "MuiTreeItem2",
...
var TreeItem22 = React77.forwardRef(function TreeItem23(inProps, forwardedRef) {
  ...
  return (0, import_jsx_runtime53.jsx)(TreeItem2Provider, {
    itemId,
    children: (0, import_jsx_runtime53.jsxs)(Root, _extends({}, rootProps, {
      children: [(0, import_jsx_runtime53.jsxs)(Content, _extends({}, contentProps, {
        children: [(0, import_jsx_runtime53.jsx)(IconContainer, _extends({}, iconContainerProps, {
          children: (0, import_jsx_runtime53.jsx)(TreeItem2Icon, {
            status,
            slots,
            slotProps
          })
        })), (0, import_jsx_runtime53.jsx)(Checkbox, _extends({}, checkboxProps)), (0, import_jsx_runtime53.jsx)(Label, _extends({}, labelProps))]
      })), children && (0, import_jsx_runtime53.jsx)(TreeItem2GroupTransition, _extends({
        as: GroupTransition
      }, groupTransitionProps))]
    }))
  });
...
true ? TreeItem22.propTypes = {
   ...
   * Must be unique.
   */
  itemId: import_prop_types35.default.string.isRequired,
  /**
...
var useTreeViewApiRef = () => React78.useRef(void 0);
export {
